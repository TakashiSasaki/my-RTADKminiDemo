...
public class RTADKminiDemoActivity extends Activity{
	...
	public void onStart() {
		...
		this.setTitle("RT-ADKminiÇ™ê⁄ë±Ç≥ÇÍÇƒÇ¢Ç‹ÇπÇÒ");
	}
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {	  
		...
		savedInstanceState.putInt("POT0", ((ProgressBar)findViewById(R.id.progress_bar0)).getProgress());
		savedInstanceState.putInt("POT1", ((ProgressBar)findViewById(R.id.progress_bar1)).getProgress());
		savedInstanceState.putInt("POT2", ((ProgressBar)findViewById(R.id.progress_bar2)).getProgress());
		savedInstanceState.putInt("POT3", ((ProgressBar)findViewById(R.id.progress_bar3)).getProgress());
    	...
    	public void handleMessage(Message msg) {
			...
			case USBAccessoryWhat:
				...
				case READ:
					...
					while(true) {
						...
						case POT0_STATUS_CHANGE:
							...
							if((value >= 0) && (value <= progressBar0.getMax())) {
						...
						case POT1_STATUS_CHANGE:
							...
							if((value >= 0) && (value <= progressBar1.getMax())) {
						...
						case POT2_STATUS_CHANGE:
							...
							if((value >= 0) && (value <= progressBar2.getMax())) {
						...
						case POT3_STATUS_CHANGE:
							...
							if((value >= 0) && (value <= progressBar3.getMax())) {
				...
				case CONNECTED:
					break;
				case READY:
					setTitle("RT-ADKminiÇ™ê⁄ë±Ç≥ÇÍÇ‹ÇµÇΩ");
					break;
				case DISCONNECTED:
					disconnectAccessory();
					break;
